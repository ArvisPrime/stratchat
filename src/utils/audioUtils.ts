...
/**
 * Encodes Float32Array PCM data into a WAV file (base64 string).
 * This is necessary because the static generateContent API handles WAV 
 * much better than raw PCM for audio understanding.
 */
